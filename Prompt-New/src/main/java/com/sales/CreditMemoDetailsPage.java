...
public class CreditMemoDetailsPage extends Base {
...
//////2nd product//////
	...
	@FindBy(xpath = "//*[text()='Orbit']")
	public WebElement productSelect;

	@FindBy (xpath = "//span[contains(text(),'2.75-17 | F | TT')]")
...
/////////////////////Credit Memo Create ////////////////////////////////////////
	...
	public void creditMemoCreate() throws Exception {
		...
		Utility.wait_N_click(billingAddressDrop);
		//driver.findElement(By.xpath("//div[@name='" + Utility.excelRead(7, 13, "CustomerDetails") + "'])[1]")).click()//origin;
		driver.findElement(By.xpath("//div[@name='Hazarimal Dharamshala']")).click();//extra
		System.out.println(1);
		Utility.SendKeysClick(addLine);
		...
		Utility.click(Uom);
		driver.findElement(By.xpath("//div[@name=\"Size\"]")).click();
// Hsn.sendKeys(HSN);
		rate.sendKeys(Rate);
		specialDiscount.sendKeys(SpclDiscnt);
		Utility.wait_N_click(tax);
		Utility.click(tax);
		driver.findElement(By.xpath("//div[@name=\"CGST (6.00%)\"]")).click();
...
//
		...
		driver.findElement(By.xpath("//div[@name=\"Size\"]")).click();
		Utility.implicitwait();
// Hsn1.sendKeys(HSN); /////HSN is excluded due change is locator id.
		rate1.sendKeys(Rate1);
		specialDiscount1.sendKeys(SpclDiscnt1);
		Utility.wait_N_click(tax1);
		Utility.click(tax1);
		driver.findElement(By.xpath("//div[@name=\"CGST (2.50%)\"]")).click();
...
//
		...
		expectedResult.add(StreetName); //// adding all elements in list array
//
////// 1st product///
...
///////////////////////////////////////////////////////////////////////////////////////
		...
		if (currentURL.equals("http://52.2.53.43/admin/create-credit-memo")) {
			...
			java.util.List<WebElement> breadCrumbList = driver.findElements(By.xpath("(//tbody)[1]"));
			...
			for (WebElement ww : breadCrumbList) {
				...
				if (ww.isDisplayed()) {
					...
					actualResult.add(billingAddActual.getText());
...
// actualResult.add(HsnActual1.getText()); //// adding all elements in list
// array
...
////////////////////////Credit Memo Negative //////////////////////////////////////////////////
	...
	public void CreditMemoNegative() throws Exception {
...
/////////////////////////// credit memo calculation //////////////////
	...
	@SuppressWarnings("unused")
	public void creditMemoCralculation() throws Exception {
