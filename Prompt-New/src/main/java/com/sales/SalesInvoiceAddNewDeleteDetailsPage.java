...
public class SalesInvoiceAddNewDeleteDetailsPage extends Base {
...
//// product 2///////
	...
	public SalesInvoiceAddNewDeleteDetailsPage() {
		PageFactory.initElements(driver, this);
	}

///////////////////////////////Sales Invoice ADD NEW and DELETE /////////////////////////////////////////////////////////	
...
////////////////////////// //////////////////////////
	...
	public void salesInvoiceAddNewCustomer() throws Exception {

//// Add new

		Thread.sleep(4000);
		Utility.click(addButton);
		Utility.wait_N_click(salesInvoiceLink);
		Thread.sleep(3000);
...
////////////////////////// //////////////////////////
	...
	public void salesInvoiceAddNewDelRelation() throws Exception {
...
///// without setting default//////
		...
		Utility.wait_N_click(relationAddressInv);
		...
		Utility.wait_N_click(relationAddressInv);
		inputRelationAdddressDropInv.sendKeys(StreetName);
		Thread.sleep(2000);
...
///// with setting default//////
		...
		Utility.implicitwait();
		System.out.println(relationAddressInv.getText());
		String defaultName = relationAddressInv.getText();
...
//Utility.wait_N_click(driver.findElement(By.xpath("(//div[@name='" + StreetName + "'])[1]//i")));
		...
		Thread.sleep(2000);
		Utility.click(relationAddressInv);
		Utility.implicitwait();
		inputRelationAdddressDropInv.sendKeys(dropname);
		Utility.implicitwait();
...
////////////////////////// //////////////////////////
	...
	public void salesInvoiceAddNewDelBilling() throws Exception {
...
//////////////////////////Shipping Address Add New and Delete ///////////////////////////////////
	...
	public void salesInvoiceAddNewDelShipping() throws Exception {
...
//////////////////////////UOM Add New and Delete //////////////////////////////
	...
	public void salesInvoiceAddNewDelUOM() throws Exception {
...
//////////////////////////Tax Add New and Delete /////////////////////////////
	...
	public void salesInvoiceAddNewDelTax() throws Exception {
...
//////////////////////////Product Add New and Delete ///////////////////////////////
	...
	public void salesInvoiceAddNewDelProduct() throws Exception {
...
//////////////////////////Payment Term Add New and Delete ///////////////////////////////
	...
	public void salesInvoiceAddNewDelPaymentTerm() throws Exception {
...
//////////////////////////Expense Add New and Delete ///////////////////////////////
	...
	public void salesInvoiceAddNewDelExpense() throws Exception {
